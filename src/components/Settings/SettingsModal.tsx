          ...
          >
            ...
            <div className="px-6 py-4 max-h-[70vh] overflow-y-auto">
              ...
              <section className="mb-6">
                <h3 className="text-sm font-medium mb-3" style={{ color: 'var(--text-primary)' }}>Streaming Service</h3>
                  ...
                  {SERVICES.map((service) => (
                    <button
                      ...
                      style={{
                        ...
                        background: activeService === service.id ? 'var(--accent-teal-dim)' : 'var(--bg-card)',
                        border: `1px solid ${activeService === service.id ? 'var(--border-glow)' : 'var(--border-subtle)'}`,
                        boxShadow: activeService === service.id ? 'var(--shadow-glow)' : 'none',
                      }}
                    >
                      ...
                      <span className="text-sm"
                        style={{
                          color: activeService === service.id ? 'var(--accent-teal)' : 'var(--text-secondary)',
                          fontWeight: activeService === service.id ? 500 : 400,
                        }}
                      >
                        {service.name}
                      </span>
              ...
              {/* Display Settings */}
              <section className="mb-6">
                <h3 className="text-sm font-medium mb-3" style={{ color: 'var(--text-primary)' }}>Display</h3>
              ...
              {/* Lyrics Settings */}
              <section className="mb-6">
                <h3 className="text-sm font-medium mb-3" style={{ color: 'var(--text-primary)' }}>Lyrics</h3>
              ...
              <section>
                <button
                  ...
                  className="w-full py-2.5 text-sm transition-all duration-150"
                  style={{
                    borderRadius: 'var(--radius-md)',
                    background: 'var(--bg-card)',
                    border: '1px solid var(--border-subtle)',
            ...
            >
              <p className="text-xs text-center" style={{ color: 'var(--text-muted)' }}>
                Keyboard shortcuts: Ctrl+, for settings, Ctrl+/- for font size
              </p>
            </div>
          </motion.div>
        </motion.div>
